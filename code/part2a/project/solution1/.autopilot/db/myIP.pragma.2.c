...
# 1 "/run/media/epetrakos/60GB/Xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 305 "/run/media/epetrakos/60GB/Xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
_ssdm_op_SpecInterface(size, "ap_stable", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(dim, "ap_stable", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(threshold, "ap_stable", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(data0, "ap_stable", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");


_ssdm_op_SpecInterface(data1, "ap_bus", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(data2, "ap_bus", 0, 0, "", 0, 1000, "", "", "", 0, 0, 0, 0, "", "");


 unsigned int i, k, l;

 for ( i = 0 ; i < size ; i ++ ) {
_ssdm_op_SpecLoopTripCount(100, 100, 100, "");

 int r = 1 ;


  for ( k = 0 ; k < dim ; k ++ ) {
_ssdm_op_SpecLoopTripCount(4, 16, 10, "");
