...
int main(int argc, char ** argv)
{
	...
	#pragma SDS async(1)
	myFuncAccel4_1( loops , dim , threshold , data0 , (dataType_bus*) data1 , (dataType_bus*) data2_hw );
	...
	#pragma SDS async(2)
	myFuncAccel4_2( loops , dim , threshold , data0 , (dataType_bus*) pointer1 , (dataType_bus*) pointer2 );
