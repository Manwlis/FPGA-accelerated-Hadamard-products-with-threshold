...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("my_input_TDATA", 32, hls_in, 19, "axis", "in_data", 1),
	Port_Property("my_input_TVALID", 1, hls_in, 19, "axis", "in_vld", 1),
	Port_Property("my_input_TREADY", 1, hls_out, 19, "axis", "in_acc", 1),
