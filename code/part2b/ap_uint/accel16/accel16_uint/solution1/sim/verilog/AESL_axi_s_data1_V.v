...
`define TV_IN_data1_V_TDATA "../tv/cdatafile/c.myFuncAccel16.autotvin_data1_V.dat"
...
module AESL_axi_s_data1_V (
    input clk,
    input reset,
    output [64 - 1:0] TRAN_data1_V_TDATA,
    ...
    reg [64 - 1:0] data1_V_TDATA_write_data;
    reg data1_V_TDATA_read_en;
    wire [64 - 1:0] data1_V_TDATA_read_data;
    
    fifo #(8000, 64) fifo_data1_V_TDATA (
        .reset(1'b0),
        .write_clock(clk),
