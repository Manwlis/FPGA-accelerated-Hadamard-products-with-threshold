...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe 0 1000 16 1000 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myFuncAccel16.autotvin.dat"
	set constFileTvOut       "myFuncAccel16.autotvout.dat"
	set constFileHdlTvIn     "myFuncAccel16.autohdltvin.dat"
	set constFileHdlTvOut    "myFuncAccel16.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
