...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("data1_V_TDATA", 128, hls_in, 19, "axis", "in_data", 1),
	Port_Property("data1_V_TVALID", 1, hls_in, 19, "axis", "in_vld", 1),
	Port_Property("data1_V_TREADY", 1, hls_out, 19, "axis", "in_acc", 1),
	Port_Property("data_out_V_TDATA", 128, hls_out, 20, "axis", "out_data", 1),
	Port_Property("data_out_V_TVALID", 1, hls_out, 20, "axis", "out_vld", 1),
	Port_Property("data_out_V_TREADY", 1, hls_in, 20, "axis", "out_acc", 1),
};
