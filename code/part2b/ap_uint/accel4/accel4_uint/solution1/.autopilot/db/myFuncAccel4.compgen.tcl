...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data1_V_TDATA { I 128 vector } data1_V_TVALID { I 1 bit } data1_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_out_V_TDATA { O 128 vector } data_out_V_TVALID { O 1 bit } data_out_V_TREADY { I 1 bit } } \
} "
} else {
