...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe 0 1000 4 100 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myFuncAccel4.autotvin.dat"
	set constFileTvOut       "myFuncAccel4.autotvout.dat"
	set constFileHdlTvIn     "myFuncAccel4.autohdltvin.dat"
	set constFileHdlTvOut    "myFuncAccel4.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
