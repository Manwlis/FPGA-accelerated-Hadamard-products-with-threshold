...
`define AUTOTB_TVIN_data1  "./c.myFuncAccel4.autotvin_data1.dat"
`define AUTOTB_TVIN_data_out  "./c.myFuncAccel4.autotvin_data_out.dat"
...
`define AUTOTB_TVIN_data1_out_wrapc  "./rtl.myFuncAccel4.autotvin_data1.dat"
`define AUTOTB_TVIN_data_out_out_wrapc  "./rtl.myFuncAccel4.autotvin_data_out.dat"
`define AUTOTB_TVOUT_data_out  "./c.myFuncAccel4.autotvout_data_out.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "./impl_rtl.myFuncAccel4.autotvout_data_out.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myFuncAccel4.autotvout_data_out.dat", "r");
    fp2 = $fopen("./impl_rtl.myFuncAccel4.autotvout_data_out.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myFuncAccel4.autotvout_data_out.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myFuncAccel4.autotvout_data_out.dat\"!");
    else begin
        $display("Comparing rtl.myFuncAccel4.autotvout_data_out.dat with impl_rtl.myFuncAccel4.autotvout_data_out.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
