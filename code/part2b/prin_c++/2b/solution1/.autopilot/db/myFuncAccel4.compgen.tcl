...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_out_req_din { O 1 bit } data_out_req_full_n { I 1 bit } data_out_req_write { O 1 bit } data_out_rsp_empty_n { I 1 bit } data_out_rsp_read { O 1 bit } data_out_address { O 32 vector } data_out_datain { I 32 vector } data_out_dataout { O 32 vector } data_out_size { O 32 vector } } \
} "
}
