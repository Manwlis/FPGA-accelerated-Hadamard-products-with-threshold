...
#define AUTOTB_TVOUT_PC_data_out  "../tv/rtldatafile/rtl.myFuncAccel4.autotvout_data_out.dat"
...
float* data_out)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *data_out_pc_buffer = new sc_bv<32>[40];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: data_out
				{
					...
					// {
						...
						// {
							sc_lv<32>* data_out_lv0_0_39_1 = new sc_lv<32>[40];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: data_out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 39; i_0 += 1)
							{
								...
								{
									data_out_lv0_0_39_1[hls_map_index].range(31, 0) = sc_bv<32>(data_out_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: data_out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 39; i_0 += 1)
							{
								...
								// output_type_conversion : (data_out_lv0_0_39_1[hls_map_index]).to_uint64()
								if (&(data_out[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&data_out[i_0] = (data_out_lv0_0_39_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* data1_tvin_wrapc_buffer = new sc_bv<32>[40];
		...
		tcl_file.set_num(40, &tcl_file.data1_depth);
		...
		sc_bv<32>* data_out_tvin_wrapc_buffer = new sc_bv<32>[40];
		...
		tcl_file.set_num(40, &tcl_file.data_out_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* data_out_tvout_wrapc_buffer = new sc_bv<32>[40];
