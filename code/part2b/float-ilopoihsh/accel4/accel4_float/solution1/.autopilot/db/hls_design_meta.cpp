...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("my_input1_TDATA", 32, hls_in, 19, "axis", "in_data", 1),
	Port_Property("my_input1_TVALID", 1, hls_in, 19, "axis", "in_vld", 1),
	Port_Property("my_input1_TREADY", 1, hls_out, 19, "axis", "in_acc", 1),
	Port_Property("my_output_TDATA", 32, hls_out, 20, "axis", "out_data", 1),
	Port_Property("my_output_TVALID", 1, hls_out, 20, "axis", "out_vld", 1),
	Port_Property("my_output_TREADY", 1, hls_in, 20, "axis", "out_acc", 1),
};
