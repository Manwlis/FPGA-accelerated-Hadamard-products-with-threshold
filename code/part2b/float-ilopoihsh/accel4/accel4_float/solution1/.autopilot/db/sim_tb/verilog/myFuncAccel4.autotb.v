...
`define AUTOTB_TVIN_my_input1  "./c.myFuncAccel4.autotvin_my_input1.dat"
`define AUTOTB_TVIN_my_output  "./c.myFuncAccel4.autotvin_my_output.dat"
...
`define AUTOTB_TVIN_my_input1_out_wrapc  "./rtl.myFuncAccel4.autotvin_my_input1.dat"
`define AUTOTB_TVIN_my_output_out_wrapc  "./rtl.myFuncAccel4.autotvin_my_output.dat"
`define AUTOTB_TVOUT_my_output  "./c.myFuncAccel4.autotvout_my_output.dat"
`define AUTOTB_TVOUT_my_output_out_wrapc  "./impl_rtl.myFuncAccel4.autotvout_my_output.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 431;
...
wire [31 : 0] data0_14;
wire [31 : 0] data0_15;
wire [31 : 0] my_input1_TDATA;
wire  my_input1_TVALID;
wire  my_input1_TREADY;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .data0_14(data0_14),
    .data0_15(data0_15),
    .my_input1_TDATA(my_input1_TDATA),
    .my_input1_TVALID(my_input1_TVALID),
    .my_input1_TREADY(my_input1_TREADY),
...
reg [31:0] ap_c_n_tvin_trans_num_my_input1;

reg my_input1_ready_reg; // for self-sync

wire my_input1_ready;
wire my_input1_done;
wire [31:0] my_input1_transaction;
wire axi_s_my_input1_TVALID;
wire axi_s_my_input1_TREADY;

AESL_axi_s_my_input1 AESL_AXI_S_my_input1(
    .clk(AESL_clock),
    .reset(AESL_reset),
    .TRAN_my_input1_TDATA(my_input1_TDATA),
    .TRAN_my_input1_TVALID(axi_s_my_input1_TVALID),
    .TRAN_my_input1_TREADY(axi_s_my_input1_TREADY),
    .ready(my_input1_ready),
    .done(my_input1_done),
    .transaction(my_input1_transaction));

assign my_input1_ready = ready;
assign my_input1_done = 0;

assign my_input1_TVALID = axi_s_my_input1_TVALID;

assign axi_s_my_input1_TREADY = my_input1_TREADY;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myFuncAccel4.autotvout_my_output.dat", "r");
    fp2 = $fopen("./impl_rtl.myFuncAccel4.autotvout_my_output.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myFuncAccel4.autotvout_my_output.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myFuncAccel4.autotvout_my_output.dat\"!");
    else begin
        $display("Comparing rtl.myFuncAccel4.autotvout_my_output.dat with impl_rtl.myFuncAccel4.autotvout_my_output.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_my_input1;
reg [31:0] size_my_input1;
reg [31:0] size_my_input1_backup;
reg end_my_output;
...
begin
    ...
    initial begin : proc_gen_axis_internal_ready_my_input1
        my_input1_ready_reg = 0;
        @ (posedge ready_initial);
        forever begin
            @ (ap_c_n_tvin_trans_num_my_input1 or my_input1_transaction);
            if (ap_c_n_tvin_trans_num_my_input1 > my_input1_transaction) begin
                my_input1_ready_reg = 1;
            end else begin
                my_input1_ready_reg = 0;
            end
        end
    ...
    `define STREAM_SIZE_IN_my_input1 "./stream_size_in_my_input1.dat"
    
    initial begin : gen_ap_c_n_tvin_trans_num_my_input1
        integer fp_my_input1;
        reg [127:0] token_my_input1;
        integer ret;
        
        ap_c_n_tvin_trans_num_my_input1 = 0;
        end_my_input1 = 0;
        wait (AESL_reset === 1);
        
        fp_my_input1 = $fopen(`AUTOTB_TVIN_my_input1, "r");
        if(fp_my_input1 == 0) begin
            $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_my_input1);
            $finish;
        end
        read_token(fp_my_input1, token_my_input1); // should be [[[runtime]]]
        if (token_my_input1 != "[[[runtime]]]") begin
            $display("ERROR: token_my_input1 != \"[[[runtime]]]\"");
            $finish;
        end
        ap_c_n_tvin_trans_num_my_input1 = ap_c_n_tvin_trans_num_my_input1 + 1;
        read_token(fp_my_input1, token_my_input1); // should be [[transaction]] or [[[/runtime]]]
        if (token_my_input1 == "[[[/runtime]]]") begin
            $fclose(fp_my_input1);
            end_my_input1 = 1;
        end else begin
            end_my_input1 = 0;
            read_token(fp_my_input1, token_my_input1); // should be transaction number
            read_token(fp_my_input1, token_my_input1);
        end
        while (token_my_input1 == "[[/transaction]]" && end_my_input1 == 0) begin
            ap_c_n_tvin_trans_num_my_input1 = ap_c_n_tvin_trans_num_my_input1 + 1;
            read_token(fp_my_input1, token_my_input1); // should be [[transaction]] or [[[/runtime]]]
            if (token_my_input1 == "[[[/runtime]]]") begin
                $fclose(fp_my_input1);
        ...
        forever begin
            @ (posedge AESL_clock);
            if (end_my_input1 == 0) begin
                if ((my_input1_TREADY & my_input1_TVALID) == 1) begin
                    read_token(fp_my_input1, token_my_input1);
                    while (token_my_input1 == "[[/transaction]]" && end_my_input1 == 0) begin
                        ap_c_n_tvin_trans_num_my_input1 = ap_c_n_tvin_trans_num_my_input1 + 1;
                        read_token(fp_my_input1, token_my_input1); // should be [[transaction]] or [[[/runtime]]]
